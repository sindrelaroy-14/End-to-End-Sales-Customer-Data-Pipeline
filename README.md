...
This project demonstrates a production-grade, end-to-end data pipeline utilizing a Medallion Architecture. 
It migrates raw e-commerce data (Olist Kaggle Dataset) from AWS S3 into a Databricks Lakehouse, implementing complex CDC (Change Data Capture) logic, and orchestrating the entire workflow with Apache Airflow.
